        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6">
                    ...
                    {{-- Note: '247 amazing products' can be made dynamic later --}}
            ...
            <div class="row">
                ...
                <div class="col-lg-9">
                    ...
                    <div class="products-grid row g-4" id="productsGrid">
                        {{-- NOTE: This entire block of 12 product cards is where a @foreach loop would go to fetch dynamic data. --}}
                        {{-- For now, they are kept static as requested. --}}
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="product-card modern-card">
                                <div class="product-badge badge-new">New</div>
                                <div class="quick-view-btn">
                                    <button class="btn btn-sm btn-light" data-bs-toggle="modal" data-bs-target="#quickViewModal"><i class="fas fa-eye"></i></button>
                                </div>
                                <div class="product-image">
                                    <div class="image-overlay-gradient"></div>
                                    <img src="https://picsum.photos/300/300?random=25" alt="Product">
                                    <div class="product-overlay">
                                        <a href="{{ url('product') }}" class="btn btn-sm btn-light me-2 btn-float"><i class="fas fa-shopping-bag"></i></a>
                                        <button class="btn btn-sm btn-light btn-float"><i class="fas fa-heart"></i></button>
                                    </div>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="product-card modern-card">
                                ...
                                <div class="product-image">
                                    <div class="image-overlay-gradient"></div>
                                    <img src="https://picsum.photos/300/300?random=26" alt="Product">
                                    <div class="product-overlay">
                                        <a href="{{ url('product') }}" class="btn btn-sm btn-light me-2 btn-float"><i class="fas fa-shopping-bag"></i></a>
                                        <button class="btn btn-sm btn-light btn-float"><i class="fas fa-heart"></i></button>
                                    </div>
                                ...
                                <div class="product-info">
                                    ...
                                    <h5 class="product-title">Aromatic Candle Set</h5>
                                    <div class="product-rating">
                                        <i class="fas fa-star"></i>
                                        <i class="fas fa-star"></i>
                                        <i class="fas fa-star"></i>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="product-card modern-card">
                                ...
                                <div class="product-image">
                                    <div class="image-overlay-gradient"></div>
                                    <img src="https://picsum.photos/300/300?random=27" alt="Product">
                                    <div class="product-overlay">
                                        <a href="{{ url('product') }}" class="btn btn-sm btn-light me-2 btn-float"><i class="fas fa-shopping-bag"></i></a>
                                        <button class="btn btn-sm btn-light btn-float"><i class="fas fa-heart"></i></button>
                                    </div>
                                ...
                                <div class="product-info">
                                    ...
                                    <h5 class="product-title">Luxury Perfume Collection</h5>
                                    <div class="product-rating">
                                        <i class="fas fa-star"></i>
                                        <i class="fas fa-star"></i>
                                        <i class="fas fa-star"></i>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="product-card modern-card">
                                ...
                                <div class="product-image">
                                    <div class="image-overlay-gradient"></div>
                                    <img src="https://picsum.photos/300/300?random=28" alt="Product">
                                    <div class="product-overlay">
                                        <a href="{{ url('product') }}" class="btn btn-sm btn-light me-2 btn-float"><i class="fas fa-shopping-bag"></i></a>
                                        <button class="btn btn-sm btn-light btn-float"><i class="fas fa-heart"></i></button>
                                    </div>
                                ...
                                <div class="product-info">
                                    <span class="product-category">Fashion</span>
                                    <h5 class="product-title">Leather Crossbody Bag</h5>
                                    <div class="product-rating">
                                        <i class="fas fa-star"></i>
                                        <i class="fas fa-star"></i>
                                        <i class="fas fa-star"></i>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="product-card modern-card">
                                ...
                                <div class="product-image">
                                    <div class="image-overlay-gradient"></div>
                                    <img src="https://picsum.photos/300/300?random=29" alt="Product">
                                    <div class="product-overlay">
                                        <a href="{{ url('product') }}" class="btn btn-sm btn-light me-2 btn-float"><i class="fas fa-shopping-bag"></i></a>
                                        <button class="btn btn-sm btn-light btn-float"><i class="fas fa-heart"></i></button>
                                    </div>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="product-card modern-card">
                                ...
                                <div class="product-image">
                                    <div class="image-overlay-gradient"></div>
                                    <img src="https://picsum.photos/300/300?random=30" alt="Product">
                                    <div class="product-overlay">
                                        <a href="{{ url('product') }}" class="btn btn-sm btn-light me-2 btn-float"><i class="fas fa-shopping-bag"></i></a>
                                        <button class="btn btn-sm btn-light btn-float"><i class="fas fa-heart"></i></button>
                                    </div>
                                ...
                                <div class="product-info">
                                    <span class="product-category">Home & Garden</span>
                                    <h5 class="product-title">Modern Table Lamp</h5>
                                    <div class="product-rating">
                                        <i class="fas fa-star"></i>
                                        <i class="fas fa-star"></i>
                                        <i class="fas fa-star"></i>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="product-card modern-card">
                                ...
                                <div class="product-image">
                                    <div class="image-overlay-gradient"></div>
                                    <img src="https://picsum.photos/300/300?random=31" alt="Product">
                                    <div class="product-overlay">
                                        <a href="{{ url('product') }}" class="btn btn-sm btn-light me-2 btn-float"><i class="fas fa-shopping-bag"></i></a>
                                        <button class="btn btn-sm btn-light btn-float"><i class="fas fa-heart"></i></button>
                                    </div>
                        ...
                        {{-- NOTE: Missing original Product 2, 3, 4, 5, 13-16 to complete 12 columns in the original row/grid layout. Adding filler products for layout completeness. --}}
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="product-card modern-card">
                                ...
                                <div class="product-image">
                                    <div class="image-overlay-gradient"></div>
                                    <img src="https://picsum.photos/300/300?random=32" alt="Product">
                                    <div class="product-overlay">
                                        <a href="{{ url('product') }}" class="btn btn-sm btn-light me-2 btn-float"><i class="fas fa-shopping-bag"></i></a>
                                        <button class="btn btn-sm btn-light btn-float"><i class="fas fa-heart"></i></button>
                                    </div>
                                ...
                                <div class="product-info">
                                    ...
                                    <h5 class="product-title">Advanced Yoga Mat</h5>
                                    <div class="product-rating">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="product-card modern-card">
                                ...
                                <div class="product-image">
                                    <div class="image-overlay-gradient"></div>
                                    <img src="https://picsum.photos/300/300?random=33" alt="Product">
                                    <div class="product-overlay">
                                        <a href="{{ url('product') }}" class="btn btn-sm btn-light me-2 btn-float"><i class="fas fa-shopping-bag"></i></a>
                                        <button class="btn btn-sm btn-light btn-float"><i class="fas fa-heart"></i></button>
                                    </div>
                                ...
                                <div class="product-info">
                                    ...
                                    <h5 class="product-title">The Elegant Cookbook</h5>
                                    <div class="product-rating">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="product-card modern-card">
                                ...
                                <div class="product-image">
                                    <div class="image-overlay-gradient"></div>
                                    <img src="https://picsum.photos/300/300?random=34" alt="Product">
                                    <div class="product-overlay">
                                        <a href="{{ url('product') }}" class="btn btn-sm btn-light me-2 btn-float"><i class="fas fa-shopping-bag"></i></a>
                                        <button class="btn btn-sm btn-light btn-float"><i class="fas fa-heart"></i></button>
                                    </div>
                                ...
                                <div class="product-info">
                                    <span class="product-category">Beauty</span>
                                    <h5 class="product-title">Night Repair Cream</h5>
                                    <div class="product-rating">
                                        <i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i>
                                        <span>(105)</span>
                                    </div>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="product-card modern-card">
                                ...
                                <div class="product-image">
                                    <div class="image-overlay-gradient"></div>
                                    <img src="https://picsum.photos/300/300?random=35" alt="Product">
                                    <div class="product-overlay">
                                        <a href="{{ url('product') }}" class="btn btn-sm btn-light me-2 btn-float"><i class="fas fa-shopping-bag"></i></a>
                                        <button class="btn btn-sm btn-light btn-float"><i class="fas fa-heart"></i></button>
                                    </div>
                                ...
                                <div class="product-info">
                                    <span class="product-category">Electronics</span>
                                    <h5 class="product-title">Portable Power Bank</h5>
                                    <div class="product-rating">
                                        <i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star-half-alt"></i>
                                        <span>(170)</span>
                                    </div>
